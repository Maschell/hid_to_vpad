...
ContentHome::ContentHome():ContentTemplate()
    ...
    , welcomeHeadLineLabel(gettext("Welcome to HID to VPAD!"))
    , welcomeTextLabel(gettext("HID to VPAD allows you to use your USB controller on your WiiU. Currently you can emulate the Gamepad or a Pro Controller."))
    , welcomeTextLabel2(gettext("Before you use your controller, you may need to provide a valid config. More information and config files can be found in the help section or on gbatemp.net (gbatemp.net/threads/424127/)."))
    , welcomeTextLabel3(gettext("To map a device, select a controller from the list on the left hand side."))
